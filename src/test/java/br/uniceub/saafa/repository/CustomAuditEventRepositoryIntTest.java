...
import br.uniceub.saafa.config.audit.AuditEventConverter;
import br.uniceub.saafa.domain.PersistentAuditEvent;
...
import static br.uniceub.saafa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
